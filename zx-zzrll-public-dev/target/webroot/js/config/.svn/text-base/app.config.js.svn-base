	  ...
	  'zx_register':{
        ...
        'zx_job_application':{
          ...
          'zx_job_applicationios':{
            ...
            js:['js/module/main/zx_Job-applicationios.js']
        },
         'zx_quitappylecode':{
            title:'离职申请页面',
            hideHeadTitle:'1',
          	//noMenubar:'1',
            html:'html/module/main/zx_QuitappyleCode.html',
            js:['js/module/main/zx_QuitappyleCode.js']
        },
         'zx_submitinfo':{
            title:'离职提交申请页面',
            hideHeadTitle:'1',
          	//noMenubar:'1',
            html:'html/module/main/zx_SubmitQuitappyle.html',
          	js:['js/module/main/zx_SubmitQuitappyle.js','js/module/main/signature_pad.js']
        },
         'zx_approvePay':{
            title:'审批缴费页面',
            hideHeadTitle:'1',
        ...
        'zx_bankAlipay':{
            ...
            html:'html/module/main/zx_Bankalipay.html',
          	js:['js/module/public/mui.picker.js',
           		 'js/module/public/mui.poppicker.js',
           		  'js/module/public/city-picker.data.js',
          		'js/module/main/zx_Bankalipay.js',
          		'js/module/main/city-picker.js']
        },
        'zx_bossAudit':{
            title:'最高主管审批',
            hideHeadTitle:'1',
          	 //noMenubar:'1',
            html:'html/module/main/zx_bossAudit.html',
            js:['js/module/muiJs/mui.min.js','js/module/main/zx_bossAudit.js']
        },
        'zx_leaveBossAudit':{
            title:'离职申请最高主管审批',
            hideHeadTitle:'1',
          	 //noMenubar:'1',
            html:'html/module/main/zx_leaveBossAudit.html',
            js:['js/module/muiJs/mui.min.js','js/module/main/zx_leaveBossAudit.js']
        },
         'zx_commonAudit':{
            title:'普通外勤审批',
            hideHeadTitle:'1',
